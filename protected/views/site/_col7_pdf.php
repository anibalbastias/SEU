...
$nuevafecha2 = date ( 'l j/m' , strtotime("sunday this week"));
$m2_f2 = explode(" ", $nuevafecha2);

echo "<h3>Domingo ".$m2_f2[1]."</h3>";

$nuevafecha3 = date ( 'l j-m' , strtotime("sunday this week"));
...
if($model)
{
    foreach($model as $m)
    {
        ...
        if($m2_f1[0] == 'Sunday' && ($m2[0] == $m2_f3[1]))
        {
