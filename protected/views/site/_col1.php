...
$nuevafecha2 = date ( 'l j/m' , strtotime("monday this week"));
$m2_f2 = explode(" ", $nuevafecha2);

echo "<h4>Lun ".$m2_f2[1]."</h4>";

$nuevafecha3 = date ( 'l j-m' , strtotime("monday this week"));
...
if($model)
{
    foreach($model as $m)
    {
        ...
        if($m2_f1[0] == 'Monday' && ($m2[0] == $m2_f3[1]))
        {
            ...
            else if($model3 == Yii::app()->session['var'] && $count1 == 0)
            {
